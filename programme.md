    ...
    <div class="card-body">
        <table>
            <tbody>
                <div style="margin-bottom: 1em;">Session chair: <i>Jennifer Firth</i></div>
                <tr>
                    <td width=100px valign="top">14:30-15:00</td><td style="padding-bottom: 1em;"><b> Cadenza Team Submissions</b>  <a href="https://youtu.be/Hvso9NkTx1k" target="_blank">[Recording]</a> <a href="./presentations/CAD1_Baseline_and_submissions.pdf" target="_blank">[Slides]</a>  <span class="author">Gerardo Roa Dabike<sup>4</sup>, Michael A. Akeroyd<sup>1</sup>, Scott Bannister<sup>2</sup>, Jon Barker<sup>3</sup>, Trevor J. Cox<sup>4</sup>, Bruno Fazenda<sup>4</sup>, Jennifer Firth<sup>1</sup>, Simone Graetzer<sup>4</sup>, Alinka Greasley<sup>2</sup>, Rebecca Vos<sup>4</sup>, William Whitmer<sup>1</sup></span><i> &#40;<sup>1</sup>University of Nottingham; <sup>2</sup>University of Leeds; <sup>3</sup>University of Sheffield; <sup>4</sup>University of Salford&#41;</i></td>
                </tr> 
            </tbody>
        </table>
    </div>
